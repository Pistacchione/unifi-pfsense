...
2. Run this one-line command, which downloads the install script from Github and executes it with sh:
  ...
  ```
    fetch -o - https://git.io/fNmKR | sh -s
  ```
...
The git.io link above should point to `https://raw.githubusercontent.com/pistacchione/unifi-pfsense/master/install-unifi/install-unifi.sh`
